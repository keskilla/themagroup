...
<div class="col-md-10" style="float: right">
  ...
  <form method="post" action="index.php?action=categorieDelete" style="border:solid 1px #0000001f; box-shadow: 1px 1px 12px #55555585;border-radius:5px;">
      <div class="p-2">
        <div class="form-group ">
          <label for="exampleFormControlSelect1">Choisir le nom de la catégorie</label>
